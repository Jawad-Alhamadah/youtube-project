    ...
    return (
        ...
        <div className='flex flex-wrap  max-md:justify-center justify-between px-5 py-3 sticky top-0 bg-[#0f0f0f] z-10'>
            ...
            <div className='space-x-5 flex items-center'>
                ...
                <div className=''>
                    <Link to="/videos">
                        <svg xmlns="http://www.w3.org/2000/svg" id="yt-logo-updated-svg_yt6" class="external-icon" viewBox="0 0 90 20" focusable="false" aria-hidden="true" className='inherit pointer-events-none  w-[100px] ' >
                            <svg id="yt-logo-updated_yt6" viewBox="0 0 90 20" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <g>
                                    <g id="youtube-paths_yt6" fill="white">
            ...
            <div className='max-sm:mt-5 flex  items-center max-sm:w-[80%] w-[53%] justify-start'>

                <input placeholder='Search' className='focus:outline-none text-white px-4 rounded-l-full bg-transparent border-[1px] border-[#303030] py-2 w-[70%]' onChange={handleSearchChange} type="text" />
                <Link to={`/Search/${searchValue}`} className=' bg-[#272727] py-2 px-4 text-2xl  border-[1px] border-[#303030] rounded-r-full'><IoIosSearch /></Link>
                <button className=' bg-[#272727] mx-3 text-lg p-3 rounded-full'><FaMicrophone /></button>
            </div>

            <div className='max-md:pt-4 space-x-6 flex items-center'>
                <div className='  rounded-full'><VscDeviceCameraVideo className='text-lg' /></div>
                <div className='  rounded-full'><FaRegBell className='text-lg' /></div>
                <div onClick={logout} className={`cursor-pointer bg-[#272727] py-1 text-md px-3  rounded-full ${localStorage.getItem("username") ? "" : "hidden"}`}> Log out</div>
                {localStorage.getItem("username") ?
                    <div className='text-lg size-9 bg-blue-400 rounded-full flex justify-center items-center'> J</div>
                    :
                    <Link to={`/login`} className='flex items-center space-x-2 bg-[#272727] py-2 px-4  border-[1px] border-[#303030] rounded-full'><HiOutlineUserCircle className='text-2xl' />Sign in</Link>
                }
